                ...
                <div class="body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control show-tick ms select2" name="type" id="type" onchange="is_edited()">
                            <option value="">-- Please select --</option>
                             <option value="topbar_menu" @if($data->type == 'topbar_menu') selected @endif>Topbar Menu</option>
                            ...
                            <option value="quick_link" @if($data->type == 'quick_link') selected @endif>Quick Menu</option>
                        </select>                            
                    </div>
                    <div class="form-group">

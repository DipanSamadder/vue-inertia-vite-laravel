...
@endphp
 ...
 <div class="row clearfix">
    @if(dsld_check_permission(['add-placements']))
    <div class="col-lg-8">
    @else
    <div class="col-lg-12">
    @endif
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form id="add_new_form" action="{{ route('pages.store') }}" method="POST" enctype="multipart/form-data" >
                            <input type="hidden" name="type" value="placements">
                            @csrf 
...
@section('footer')
    ...
    <input type="hidden" name="get_pages" id="get_pages" value="{{ route('placements.ajax_data') }}">

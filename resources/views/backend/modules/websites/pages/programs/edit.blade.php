                ...
                <div class="body">
                    ...
                    <div class="form-group">
                        ...
                        <option value="default" @if($data->template == 'default') selected @endif>Default</option>
                            ...
                            <option value="programs_listing" @if($data->template == 'programs_listing') selected @endif>Program Listing</option>                            

                            <option value="programs_details" @if($data->template == 'programs_details') selected @endif>Program Details</option>  
                        ...
                        <select class="form-control show-tick ms select2" name="parent" id="parent" onchange="is_edited()">
                            ...
                            @php 
                                ...
                                if($data->id == '73'){
                                    ...
                                    $childs = $childs->where('type', 'programs_details');

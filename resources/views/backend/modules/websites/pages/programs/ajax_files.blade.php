...
<table class="table table-bordered table-striped table-hover dataTable">
    ...
    <thead>
            ...
            <tr class="text-center">
                ...
                @if(dsld_check_permission(['edit-programs']))
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="text-center mb-0 action_items">
                            ...
                            <a href="{{ route('programs.edit', ['id'=>$value->id, 'lang'=>env('DEFAULT_LANGUAGE')]) }}"  class="btn btn-default waves-effect waves-float btn-sm waves-red bg-primary">
                            ...
                            @if(dsld_check_permission(['delete-programs']))

...
<table class="table table-bordered table-striped table-hover dataTable">
    <thead>
            <tr class="text-center">
                ...
                <th>Meta Title</th>
                <th>Date</th>
                @if(dsld_check_permission(['edit-departments']))
                <th>Status</th>
                @endif
                <th>Action</th>
            </tr>
                ...
                <tr>
                    ...
                    <td>
                        <p class="text-center mb-0 action_items">
                            ...
                            @if(dsld_check_permission(['edit-departments']))
                            <a href="{{ route('departments.edit', ['id'=>$value->id, 'lang'=>env('DEFAULT_LANGUAGE')]) }}"  class="btn btn-default waves-effect waves-float btn-sm waves-red bg-primary">
                                <i class="zmdi zmdi-edit"></i>
                            </a>
                            @endif
                            
                            @if(dsld_check_permission(['delete-departments']))

...
<input type="hidden" name="type" id="type" value="contact_form" />
<div class="body">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="layout" id="edit_layout" onchange="is_edited()">
                            ...
                            <option value="grievances_layout"  @if(dsld_page_meta_value_by_meta_key('layout', $data->id) == 'grievances_layout') selected @endif>Grievances Layout</option>
                            
                            <option value="super_admin_layout"  @if(dsld_page_meta_value_by_meta_key('layout', $data->id) == 'super_admin_layout') selected @endif>Super Admin Layout</option>
                        </select>                                   
                    </div>
                </div>
                <div class="col-sm-12">

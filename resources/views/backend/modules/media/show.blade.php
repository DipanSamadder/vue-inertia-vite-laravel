...
<div class="row clearfix">
    ...
    <form class="form-inline" id="search_media">
        ...
        <div class="col-lg-4">
            <div class="form-group">                                    
                <input type="text" class="form-control" name="msearch" onblur="filter()" placeholder="Search File name">
            </div>
        </div>
    </form>
    </div>
...
<script>
    ...
    function file_copy(link){
        var temp = $("<input>");
        $("body").append(temp);
        temp.val(link).select();
        document.execCommand("copy");
        temp.remove();
        dsldFlashNotification('success', 'Link Copied!!');
    }

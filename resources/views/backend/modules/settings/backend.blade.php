                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <a class="btn btn-primary text-white" onclick="media_file_get('{{ dsld_get_setting("dashboard_logo") }}','put_image', 0)"><i class="zmdi zmdi-collection-image"></i></a><div class="put_image">@if(!is_null(dsld_get_setting('dashboard_logo')))<strong>Selected Image:</strong><i> {{ dsld_get_setting('dashboard_logo') }}</i>@endif</div>
                        
                                            <input type="hidden" class="put_image" name="dashboard_logo" id="dashboard_logo" value="{{ dsld_get_setting('dashboard_logo') }}" onchange="is_edited()">

                                            @if(dsld_get_setting('dashboard_logo') > 0)
                                            <div class="image mt-2">
                                                <img src="{{ dsld_uploaded_file_path(dsld_get_setting('dashboard_logo')) }}"  alt="{{ dsld_upload_file_title(dsld_get_setting('dashboard_logo')) }}" class="page_banner_icon">
                                            </div> 
                                            @endif                                                            
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <a class="btn btn-primary text-white" onclick="media_file_get('{{ dsld_get_setting("dashboard_fav_icon") }}','put_image1', 0)"><i class="zmdi zmdi-collection-image"></i></a><div class="put_image1">@if(!is_null(dsld_get_setting('dashboard_fav_icon')))<strong>Selected Image:</strong><i> {{ dsld_get_setting('dashboard_fav_icon') }}</i>@endif</div>
                        
                                            <input type="hidden" class="put_image1" name="dashboard_fav_icon" id="dashboard_fav_icon" value="{{ dsld_get_setting('dashboard_fav_icon') }}" onchange="is_edited()">

                                            @if(dsld_get_setting('dashboard_fav_icon') > 0)
                                            <div class="image mt-2">
                                                <img src="{{ dsld_uploaded_file_path(dsld_get_setting('dashboard_fav_icon')) }}"  alt="{{ dsld_upload_file_title(dsld_get_setting('dashboard_fav_icon')) }}" class="page_banner_icon">
                                            </div> 
                                            @endif                                                            
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <a class="btn btn-primary text-white" onclick="media_file_get('{{ dsld_get_setting("dashboard_loader_icon") }}','put_image2', 0)"><i class="zmdi zmdi-collection-image"></i></a><div class="put_image2">@if(!is_null(dsld_get_setting('dashboard_loader_icon')))<strong>Selected Image:</strong><i> {{ dsld_get_setting('dashboard_loader_icon') }}</i>@endif</div>
                        
                                            <input type="hidden" class="put_image2" name="dashboard_loader_icon" id="dashboard_loader_icon" value="{{ dsld_get_setting('dashboard_loader_icon') }}" onchange="is_edited()">


                                            @if(dsld_get_setting('dashboard_loader_icon') > 0)
                                            <div class="image mt-2">
                                                <img src="{{ dsld_uploaded_file_path(dsld_get_setting('dashboard_loader_icon')) }}"  alt="{{ dsld_upload_file_title(dsld_get_setting('dashboard_loader_icon')) }}" class="page_banner_icon">
                                            </div> 
                                            @endif                                                            
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <a class="btn btn-primary text-white" onclick="media_file_get('{{ dsld_get_setting("dashboard_registration_background") }}','put_image4', 0)"><i class="zmdi zmdi-collection-image"></i></a><div class="put_image4">@if(!is_null(dsld_get_setting('dashboard_registration_background')))<strong>Selected Image:</strong><i> {{ dsld_get_setting('dashboard_registration_background') }}</i>@endif</div>
                        
                                            <input type="hidden" class="put_image4" name="dashboard_registration_background" id="dashboard_registration_background" value="{{ dsld_get_setting('dashboard_registration_background') }}" onchange="is_edited()">
                                            @if(dsld_get_setting('dashboard_registration_background') > 0)
                                            <div class="image mt-2">
                                                <img src="{{ dsld_uploaded_file_path(dsld_get_setting('dashboard_registration_background')) }}"  alt="{{ dsld_upload_file_title(dsld_get_setting('dashboard_registration_background')) }}" class="page_banner_icon">
                                            </div> 
                                            @endif                                                            
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="types[]" id="types" value="dashboard_notifications">
                                            <input type="text" class="form-control" placeholder="Notification" name="dashboard_notifications"  id="dashboard_notifications" @if(!empty(dsld_get_setting('dashboard_notifications'))) value="{{ dsld_get_setting('dashboard_notifications') }}" @endif>
                                            <small> Default Put only "Notification" text.</small>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12">

...
@endphp
 ...
 <div class="row clearfix">
    @if(dsld_check_permission(['add-templates']))
    <div class="col-lg-8">
    @else
    <div class="col-lg-12">
    @endif
    ...
    <div class="col-lg-4">
        ...
        <div class="card">
            ...
            <div class="body">
                <div class="row">
                    <div class="col-lg-12">
                        <form id="add_new_form" action="{{ route('templates.store') }}" method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="modal-body">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="template" class="form-control" placeholder="Template" />                                   
                                    </div>
                                </div>
...
@section('footer')
    ...
    <div class="modal fade" id="edit_larger_modals" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="update_form" action="{{ route('templates.update') }}" method="POST" enctype="multipart/form-data" >
                @csrf 
                <div class="modal-body">
    ...
    <input type="hidden" name="get_pages" id="get_pages" value="{{ route('ajax_templates') }}">

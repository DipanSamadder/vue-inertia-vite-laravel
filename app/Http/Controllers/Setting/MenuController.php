...
class MenuController extends Controller
{
    public function index(){
        ...
        return view('backend.modules.websites.menus.show', compact('page'));
    }
    public function get_ajax_menus(Request $request){
        ...
        return view('backend.modules.websites.menus.ajax_menus', compact('data'));
    }
    ...
    public function edit($id){
        ...
        return view('backend.modules.websites.menus.edit', compact('data', 'page'));
    }

    public function menus_ordering($type){
        $data = Menu::where('type', $type)->where('status', 0)->orderBy('order', 'desc')->get();
        $page['title'] = 'Edit Type';
        return view('backend.modules.websites.menus.ordering', compact('data', 'page', 'type'));
    }
